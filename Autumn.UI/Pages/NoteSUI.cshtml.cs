...
namespace Autumn.UI.Pages
{
    public class NoteSUIModel : PageModel
    {
        ...
        public NoteSUIModel(IHsCodeService hscodeService, IDocumentService documentService, IHsCodeDocumentService hscodeToDocumentService, ICustomsTariffService customsTariffService) {
