...
namespace Autumn.UI.Pages
{
    public class NoteSUIModel : PageModel
    {
        ...
        public NoteSUIModel(IHsCodeService hscodeService, DocumentService documentService, HSCodeToDocumentService hscodeToDocumentService, ICustomsTariffService customsTariffService) {
