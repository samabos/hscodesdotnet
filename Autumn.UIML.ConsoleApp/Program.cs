...
namespace Autumn_UIML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"C:\Users\sage x\source\repos\autumn\Documentation\classification\newproductscleaned2.csv";
